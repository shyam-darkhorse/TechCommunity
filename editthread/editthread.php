...
<body class="zf-backgroundBg" >
	...
	<div class="zf-templateWidth">
		<form action='back.php' name='form' method='POST' onSubmit='javascript:document.charset="UTF-8"; return zf_ValidateAndSubmit();' accept-charset='UTF-8' enctype='multipart/form-data' id='form'>
		<input type="hidden" name="zf_referrer_name" value="">
				<div class="zf-templateWrapper">
			<!---------template Header Starts Here---------->
			<ul class="zf-tempHeadBdr">
				<li class="zf-tempHeadContBdr">
				<h2 class="zf-frmTitle"><em>Edit Thread</em></h2>
				<p class="zf-frmDesc">Please modify the details of the event!!</p>
	...
	<ul>
		...
		$eventdet= $conn->query($sql);
		$disp='NONE';
	if($se =$eventdet->fetch_assoc())
	{
		
		$disp='<li class="zf-tempFrmWrapper zf-medium">
		<label class="zf-labelName">	Event title 	<em class="zf-important">*</em>		</label>
		<div class="zf-tempContDiv">
			<span> 
				<input type="text" name="event_name" checktype="c1" value="'.$se['eventname'].'" maxlength="255" invlovedinsalesiq=false />
			</span>
		...
		<div class="zf-tempContDiv">
			<span>
				<textarea name="event_description" checktype="c1" maxlength="65535">'.$se['description'].'</textarea>
			</span>
		...
		<div class="zf-tempContDiv">
			<span> 
				<input type="text" name="venue" id="venue" value="'.$se['venue'].'" maxlength="255" invlovedinsalesiq=false />
			</span>
			<p id="SingleLine_error" class="zf-errorMessage" style="display:none;">	 Invalid value	</p>
		</div>
		<div class="zf-clearBoth">	</div>
	...
	<!---------template Container Starts Here---------->
		<ul>
			...
			<li class="zf-fmFooter" ><input type="button"  value="Cancel" class="MyButton" onclick="location.href='/tech_community/orgpage/orghome.php'"></li>
		</ul>
	</div>
