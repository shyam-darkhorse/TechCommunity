	...
	<div class="limiter" >
		<div class="container-login100" >
			<div class="wrap-login100 p-t-20 p-b-20" >
				<form class="login100-form validate-form" method="post" action="orglogback.php">
					...
					<div class="wrap-input100 validate-input m-t-30 m-b-20" data-validate = "Enter username">
						<input type="text" class="input100" size=25 name="org_id">
						<span class="focus-input100" data-placeholder="Organizer Id"></span>
					</div>
